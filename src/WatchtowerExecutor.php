...
class WatchtowerExecutor extends Executor
{
    ...
    )
    {
        ...
        ): mixed 
        {
            try {
                ...
                $type = \str_replace('_',' ',tableize($node->unwrappedType()));
                
                throw new UserError("More than one '$type' was found for the query although one or none was expected.");
            }
                ...
                throw new UserError("No '$type' was found for the query although at least one was expected.");
            }
        };
    }
